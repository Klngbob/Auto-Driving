...
#ifndef LIDAR_LOCALIZATION_SENSOR_DATA_CLOUD_SUBSCRIBER_HPP_
#define LIDAR_LOCALIZATION_SENSOR_DATA_CLOUD_SUBSCRIBER_HPP_
...
class CloudSubscriber {
    ...
    private:
        ...
        std::deque<CloudData> new_cloud_data_; // 点云数据缓冲区
};
}
