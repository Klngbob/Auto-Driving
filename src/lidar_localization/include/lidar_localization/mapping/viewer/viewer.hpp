...
class Viewer {
    public:
        ...
        bool Update(std::deque<KeyFrameData>& new_key_frames,
    ...
    private:
        ...
        bool JointCloudMap(const std::deque<KeyFrameData>& key_frames,
    ...
    private:
        ...
        Eigen::Matrix4f pose_to_optimzie_ = Eigen::Matrix4f::Identity();
